  function loadCategory(category, pageName) {
    ...
    if (category === 'all') {
        ...
        filtered = products.filter(p => p.oldPrice > 0);
    ...
    productGrid.innerHTML = currentProducts.map(product => `
        <div class="product-card">
            <div class="product-img-wrapper">
                ...
                <button class="product-wishlist-btn" data-product-id="${product.id}" onclick="toggleWishlist(${product.id}); event.stopPropagation();" title="Add to Wishlist">
